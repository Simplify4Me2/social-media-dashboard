...
export function Header({ children }: PropsWithChildren) {
  return (
    <header className="flex flex-wrap justify-between w-full font-bold mt-1.5">
      <div>
        <h1 className="text-xl lg:text-3xl text-dark-blue-800 pt-1.5 font-bold">Social Media Dashboard</h1>
        <h3 className="text-sm text-start m-px text-blue-700 mt-0.5">
